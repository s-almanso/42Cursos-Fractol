...
/*   Updated: 2023/04/02 18:42:01 by salmanso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fern(t_data *data)
{
	...
	while (data->max_n > 0)
	{
		...
		mlx_pixel_put(data->mlx_ptr, data->win_ptr, 30 * data->new_re
			+ data->width / 2, 50 * data->new_im
			+ data->height / 3, data->color);
